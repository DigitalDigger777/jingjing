 ...
 */
class AlipayCallbackController extends AbstractController
{
     ...
     * @return Response
     *
     * @Route("/payment/alipay/success", name="jingjing_payment_alipay_success")
     */
     ...
     * @return Response
     *
     * @Route("/payment/alipay/error", name="jingjing_payment_alipay_error")
     */
